...
<header class="recuadro text-recuadro">
  ...
  <div class="crud_menu">
       ...
       ?>
       <?php } ?>
       <form action="pagar.php?total=<?php echo $total?>"method="POST">
       <p style="color:#FFFFFF ";>Total: <b><?php  echo "<font color='#FFFFFF'>$total</font>"; ?></b></p>
       <input type="submit" name="pagar.php?total=<?php echo $total?>" class="btn btn-success btn-block" value="COMPRAR" id="carrito_boton">
       </form>
        </div>
      </div>
    </div>
